...
namespace DeviceSimulator
{
    public static class AzureIoTHub
    {
        ...
        //#####################################################################
        private static string hubName = "Transportation";
        private static string hubSharedAccessKey = "qgdna7Xm0bLTs5u+p+r5RD/WlksDneu7gniGUXNNO88";

        private static string device1Name = "trailer_sensor_11111101";
        private static string device1SharedAccessKey = "9/opd6tZZsARlI9LSCPFQH2EH5uB44UqJAcfs5I1fRY=";
        private static string device2Name = "trailer_sensor_22222201";
        private static string device2SharedAccessKey = "SxK5AdXG0JLp19ebKCMVvFVa5508Njf8qRooeFpVBxY=";
        private static string device3Name = "trailer_sensor_33333301";
        private static string device3SharedAccessKey = "HcC2sqslldgygyKKoKnX919jS4/3++GWLTRTlvcqlqQ=";
